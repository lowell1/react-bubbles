...
A token is used by the server tell if you are logged in to an account.
...
A web server stores information on the Internet and then computers connect to it with the world wide web and get the information by typing the url and domain name.
